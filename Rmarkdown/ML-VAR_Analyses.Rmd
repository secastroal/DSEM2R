...
abline(h = 10, col = gray(0.5))
abline(v = 10, col = gray(0.5))
```
...
for (i in 1:length(ids)) {
  plot.ts(data_var[data_var$lifepak_id == ids[i], c("interest", "sad")],
          ...
          col =1:2,
          las = 1)
  mtext(paste0("Interest: Mean = ", mean(data_var[data_var$lifepak_id == ids[i], "interest"], na.rm = TRUE), 
        ", sd =", sd(data_var[data_var$lifepak_id == ids[i], "interest"], na.rm = TRUE)), 3, at = 1, line= 2)
  mtext(paste0("Sad: Mean = ", mean(data_var[data_var$lifepak_id == ids[i], "sad"], na.rm = TRUE), 
        ", sd =", sd(data_var[data_var$lifepak_id == ids[i], "sad"], na.rm = TRUE)), 3, at = 1)
}
dev.off()
