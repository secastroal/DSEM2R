...
table(unlist(tmp_days))

as.numeric(as.Date(tmp$notification_time)) - min(as.numeric(as.Date(tmp$notification_time)))

new_beep <- as.numeric(as.Date(tmp$notification_time)) - min(as.numeric(as.Date(tmp$notification_time))) + tmp$response_no
```
